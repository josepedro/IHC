...
\newcommand{\hell}{Intera\c c\~ao Humano Computador}		%nome do arquivo
\author{\ziul}												%criador do pdf - só observado nos detalhes do pdf
\newcommand{\assunto}{Proposta de projeto final}			%Nome do experimento
\newcommand{\ver}{\assunto}						%numeração do experimento
\newcommand{\professor}{André Barros de Sales}
%%------------------------------------------------------------------------------
...
\newcommand{\rodrigo}{\href{http://lattes.cnpq.br/1109478949026592}{Rodrigo Santana Gonçalves}}	%Para link
\newcommand{\rodrigomatricula}{11/0139356}
\newcommand{\ze}{\href{http://lattes.cnpq.br/1109478949026592}{José Pedro de Santana Neto}}	%Para link
\newcommand{\zematricula}{09/0119355}
...
\@ifclassloaded{coursepaper}
{
	...
	\def\@maketitle{%
	  ...
	  \begin{flushleft}%
	    ...
	    \vskip 1em%
	    {\sffamily \large\lineskip .75em
	    \rodrigo ~-~\rodrigomatricula\\
	    \ze ~-~ \zematricula\\
...
%\markboth{Universidade de Bras\'ilia - Campus Gama - FGA, \entrega}{\ver}
%\runningheader{1}{2}{3}
